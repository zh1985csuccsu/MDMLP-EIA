...
class Dataset_ETT_hour(Dataset):
    ...
    def __read_data__(self):
        ...
        try:
            ...
            if hasattr(args, '_cached_data'):
                df_raw = args._cached_data
                print(f"Using cached data for {self.data_path}")
            else:
...
class Dataset_Solar(Dataset):
    ...
    def __getitem__(self, index):
        ...
        if hasattr(self, 'timeenc') and self.timeenc == 1:
